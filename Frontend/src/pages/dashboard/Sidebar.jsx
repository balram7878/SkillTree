...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="w-64 bg-white border-r border-[#E8DDD0] hidden md:flex flex-col py-6 shrink-0 z-10 max-h-screen rounded-xl">
        ...
        <div className="px-4 mt-auto border-t border-[#E8DDD0] m-auto">
          <button
            onClick={logout}
            className="w-full mt-1 flex items-center gap-3 px-4 py-3 text-left rounded-xl text-[#6B6B6B] hover:bg-red-50 hover:text-red-700 font-medium transition-all"
          >
